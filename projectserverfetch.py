...
sql=cursor.execute("select * from waste where email='{0}'".format(a))
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <a href='http://localhost/phpmyadmin/index.php?route=/database/structure&db=fiem/allprofile.py'>	   
                    <button class="btn-primary">PROFILE</button>
                </a>
                <a href="searchname.html">	   
                    <button class="btn-primary">REVENUE UPDATE</button>
	            </a>
                <a href="wastecontain4.html">	   
...
<!-----------services section-------------------->
    ...
    <div class="container text-center">
        ...
        <a href="sevice4.html"><button type="button" class="btn btn-primary">All services</button></a>
    </div> 
    </section> 
...
<!----------About us---------------> 
    ...
    <section id="about-us">
        ...
        <h1 class="title text-center">Why Choose Us?</h1>
            ...
            <a href="about_us4.html"><button type="button" class="btn btn-primary">More About Us</button></a>
        </div>
    </section>
<!------------testimonial---------------->
...
#   print("<script>window.alert('login successfull');</script>")
   ...
   print("<script>window.alert('wrong password or emailid');</script>")
